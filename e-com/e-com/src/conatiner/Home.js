          ...
          <div className="hero-text">
            <div className="hero-text-tablecell">
              ...
              <div className="hero-btns">
                <Link to="/singl" className="boxed-btn">Singl Page</Link>
                <Link to="/contect" className="bordered-btn">Contact Us</Link>
              </div>
            </div>
          </div>
        </div>
    ...
    <div className="container">
      <div className="row clearfix">
        ...
        <div className="content-column col-lg-6">
          ...
          <Link to="cart" className="cart-btn mt-3"><i className="fas fa-shopping-cart" /> Add to Cart</Link>
        </div>
      </div>
    </div>
  </section>
